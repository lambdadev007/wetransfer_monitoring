...
/***/ "./resources/js/app/pages/ManageDepartments/index.js":
/*!***********************************************************!*\
  !*** ./resources/js/app/pages/ManageDepartments/index.js ***!
  \***********************************************************/
...
/* harmony import */ var _tableDataHelpers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tableDataHelpers */ "./resources/js/app/pages/ManageDepartments/tableDataHelpers.js");
/* harmony import */ var _redux_actions_departments__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/redux/actions/departments */ "./resources/js/app/redux/actions/departments.js");
...
var ManageDepartments = function ManageDepartments(_ref) {
  var loadDepartments = _ref.loadDepartments,
      resetDepartments = _ref.resetDepartments,
      loading = _ref.loading,
      departmentsRows = _ref.departmentsRows,
      requesting = _ref.requesting,
      deleting = _ref.deleting,
      props = _objectWithoutProperties(_ref, ["loadDepartments", "resetDepartments", "loading", "departmentsRows", "requesting", "deleting"]);
  ...
  var filteredRows = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () {
    ...
    if (searchTextDebounced) {
      var _filtered = departmentsRows.filter(function (el) {
        for (var key in el) {
  ...
  var onAddDepartmentClick = function onAddDepartmentClick() {
...
var mapDispatch = {
  loadDepartments: _redux_actions_departments__WEBPACK_IMPORTED_MODULE_9__["departmentsListLoading"],
  resetDepartments: _redux_actions_departments__WEBPACK_IMPORTED_MODULE_9__["departmentsReset"]
};
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapState, mapDispatch)(ManageDepartments));
